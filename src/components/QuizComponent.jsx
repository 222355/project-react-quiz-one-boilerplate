    ...
    constructor(props) {
        ...
        this.state = {
            ...
            questions: [
                ...
                {
                    ques: "Name the national flower of India?",
                    options: ["Rose","Lotus"," Lily"," Sunflower"],
                    ans: "Lotus"
                },
                {
                    ques: "Which is the most sensitive organ in our body?",
                    options: ["Liver", "Brain", "Skin", "Heart"],
                    ans: "Skin"
                },
                {
                    ques: "Who invented the Computer?",
                ...
                {
                    ques: "Agra is situated on the bank of which river?",
                ...
                {
                    ques: "What is the name of the largest desert in the world?",
                    options: ["Sahara Desert", "Gobi Desert", "Kalahari Desert", "Antarctic Desert"],
                    ans: "Sahara Desert"
                },
                {
                    ques: "What is the name of the largest rainforest in the world?",
